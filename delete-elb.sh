...
[ "${ELB_LS_ARN}" != "" ] && aws elbv2 delete-listener --listener-arn ${ELB_LS_ARN}
echo "deleting load balancer.."
[ "${ELB_LB_ARN}" != "" ] && aws elbv2 delete-load-balancer --load-balancer-arn ${ELB_LB_ARN}
echo "deleting target group.."
[ "${ELB_TG_ARN}" != "" ] && aws elbv2 delete-target-group --target-group-arn ${ELB_TG_ARN}
